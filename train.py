...
train_dataset = BDD100KDataset(
    images_dir='../root/images/train/train',
    masks_dir='../root/ll_seg_annotations/train/train',
    transform=transform
)

val_dataset = BDD100KDataset(
    images_dir='../root/images/val/val',
    masks_dir='../root/ll_seg_annotations/val/val',
    transform=transform
)
...
def train_model(model, train_loader, val_loader, criterion, optimizer, num_epochs=25, model_path='unet_lane_detection.pth', start_epoch=0):
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        # get [batch_size] images and masks from train_loader
...
# Start training
train_model(model, train_loader, val_loader, criterion, optimizer, num_epochs=20, model_path='unet_lane_detection')